...
INSERT INTO public.qcm_questions (id, exam_id, text, correct_option_id, position) VALUES
  ('qqqqqqqq-0001-0001-0001-000000000001', 'eeeeeeee-0001-0001-0001-000000000001', 'كم عدد آيات سورة الفاتحة؟',          'b', 0),
  ('qqqqqqqq-0002-0002-0002-000000000002', 'eeeeeeee-0001-0001-0001-000000000001', 'ما معنى كلمة "الحمد"؟',              'a', 1),
  ('qqqqqqqq-0003-0003-0003-000000000003', 'eeeeeeee-0001-0001-0001-000000000001', 'سورة الفاتحة هي السورة رقم كم في القرآن الكريم؟', 'a', 2)
ON CONFLICT (id) DO NOTHING;

-- ── 10. QCM OPTIONS ──────────────────────────────────────────
INSERT INTO public.qcm_options (id, question_id, text) VALUES
  -- Q1: عدد الآيات
  ('a', 'qqqqqqqq-0001-0001-0001-000000000001', '5 آيات'),
  ('b', 'qqqqqqqq-0001-0001-0001-000000000001', '7 آيات'),
  ('c', 'qqqqqqqq-0001-0001-0001-000000000001', '6 آيات'),
  ('d', 'qqqqqqqq-0001-0001-0001-000000000001', '8 آيات'),
  -- Q2: معنى الحمد
  ('a', 'qqqqqqqq-0002-0002-0002-000000000002', 'الشكر والثناء'),
  ('b', 'qqqqqqqq-0002-0002-0002-000000000002', 'الدعاء'),
  ('c', 'qqqqqqqq-0002-0002-0002-000000000002', 'الصلاة'),
  ('d', 'qqqqqqqq-0002-0002-0002-000000000002', 'القراءة'),
  -- Q3: رقم السورة
  ('a', 'qqqqqqqq-0003-0003-0003-000000000003', 'السورة الأولى'),
  ('b', 'qqqqqqqq-0003-0003-0003-000000000003', 'السورة الثانية'),
  ('c', 'qqqqqqqq-0003-0003-0003-000000000003', 'السورة الثالثة'),
  ('d', 'qqqqqqqq-0003-0003-0003-000000000003', 'السورة الرابعة')
...
INSERT INTO public.exam_results (exam_id, student_id, answers, score, correct_count, total_count, date_taken) VALUES
  (
    ...
    '{
      "qqqqqqqq-0001-0001-0001-000000000001": "b",
      "qqqqqqqq-0002-0002-0002-000000000002": "a",
      "qqqqqqqq-0003-0003-0003-000000000003": "a"
    }'::jsonb,
    100, 3, 3, '2026-04-22'
  ),
  (
    ...
    '{
      "qqqqqqqq-0001-0001-0001-000000000001": "b",
      "qqqqqqqq-0002-0002-0002-000000000002": "a",
      "qqqqqqqq-0003-0003-0003-000000000003": "b"
    }'::jsonb,
    67, 2, 3, '2026-04-23'
  )
ON CONFLICT DO NOTHING;
