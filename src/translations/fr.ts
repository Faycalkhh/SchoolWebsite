...
const fr: Translations = {
  ...
  hero: {
    ...
    title1: "École",
    title2: "École coranique de la mosquée Abdelkader El Yajouri",
    subtitle: "Récitation, apprentissage et méditation ensemble vers la compagnie du Coran",
  ...
  facilities: {
    ...
    items: [
      { title: "Salle de classe", desc: "Un espace spacieux pour l'apprentissage collectif." },
      { title: "Salles de Consultation", desc: "Sessions privées avec les professeurs." },
  ...
  contact: {
    ...
    addressValue: "Canastel, Oran, Algérie",
  ...
  footer: {
    ...
    ctaBtn: "S'inscrire",
    rights: "© 2026 École coranique de la mosquée Abdelkader El Yajouri. Tous droits réservés.",
