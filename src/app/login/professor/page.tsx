...
const t = {
  ar: {
    title: "فضاء الأستاذ",
    subtitle: "سجّل دخولك للوحة التحكم",
    emailLabel: "البريد الإلكتروني",
    emailPh: "prof@email.com",
...
export default function ProfessorLogin() {
  ...
  const inputCls =
    "w-full px-4 py-3 rounded-xl border border-[#e8dfc8] bg-[#faf8f4] text-sm placeholder-[#bbb] focus:outline-none focus:border-[#2d6a4f] focus:ring-2 focus:ring-[#2d6a4f]/10 transition-all";
  const labelCls =
        ...
        <div className="bg-white rounded-3xl shadow-lg border border-[#e8dfc8] p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 rounded-xl bg-[#2d6a4f] text-white font-semibold text-sm hover:bg-[#235a40] transition-colors disabled:opacity-60 shadow-md mt-2"
            >
